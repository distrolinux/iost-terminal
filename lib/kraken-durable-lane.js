...
const requestClass = method => method === 'AddOrder' ? 'order-submission' : method === 'CancelOrder' ? 'order-cancellation' : ['GetApiKeyInfo', 'Balance', 'BalanceEx', 'OpenOrders', 'OpenPositions', 'QueryOrders', 'QueryTrades', 'TradeVolume'].includes(method) ? 'read-only' : 'unknown';
