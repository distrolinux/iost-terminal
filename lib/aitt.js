...
const DEFAULTS = {
  ...
  reserveAITT: 0, // whole-AITT display units funded into the converter
...
export function claim({ ownerId }) {
  ...
  if (!cfg.conversionOpen) {
    return {
      ...
      message: 'AITT conversion is closed under the pre-launch review hold. Planned, not guaranteed — nothing has been issued.',
  ...
  return {
    ...
    aittIssued: claimable, // whole-AITT display units; on-chain approval uses claimable * 10**8 base units
