...
import { evaluateReleaseGates, evaluateLiveReleaseGates } from './aitt-release-gates.js';
import { listClaims } from './aitt-claims.js';
import { probeReleaseState } from './aitt-chain.js';
...
const DEFAULTS = {
  ...
  contractAddress: '', converterAddress: '', feeRouterAddress: '', vaultAddresses: {}, deploymentManifestHash: '', governanceOwner: '',
