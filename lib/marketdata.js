// lib/marketdata.js — market-wide data layer (keyless): CoinGecko + Fear&Greed.
...
// working if a provider is down.
const CG = 'https://api.coingecko.com/api/v3';
const FNG = 'https://api.alternative.me/fng/';
const cache = new Map();
const TTL = { global: 60_000, movers: 90_000, extras: 120_000 };
