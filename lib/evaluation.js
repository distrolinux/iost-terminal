...
export function evaluateAgentStrategy({ symbol, timeframe = '1d', strategy, candles: input, config = {} }) {
  try {
    ...
    const benchmark = createAgentBenchmark({ ...core, promotion }, trades);
    return { ok: true, ...core, promotion, benchmark, evidence: { resultHash: evidenceHash({ ...core, promotion, benchmark, trades }) }, trades };
  } catch (error) {
