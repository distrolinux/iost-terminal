...
function recordData(expected, observation, evidence) {
  ...
  const e = { clientOrderId: id(expected.clientOrderId), venueOrderId: id(expected.venueOrderId), pair: id(expected.pair), side: expected.side, quantity: decimal(expected.quantity) };
