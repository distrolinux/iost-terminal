...
const base = {
  ...
  incidents: { counts: { open: 0, critical: 0, quarantined: 0, recoveryReady: 0 } },
  safetySlo: {
...
const denyCases = [
  ...
  ['safety-budget-available', { safetySlo: { ...base.safetySlo, status: 'budget-exhausted', errorBudget: { exhausted: true } } }],
