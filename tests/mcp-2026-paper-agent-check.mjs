...
ok('tool arguments are bounded and validated before execution', () => {
  ...
  assert.equal(validateToolArguments('paper_trade_open', {
    intentId: 'paper-intent-0001', preflightFingerprint, symbol: 'AAPL', side: 'long', size: 1, entry: 10, maxSlippageBps: 50, walletId: 'wallet-1', pactId: 'pact-1',
  }, access).ok, true);
  assert.match(validateToolArguments('paper_trade_open', {
    intentId: 'paper-intent-0001', preflightFingerprint, symbol: 'AAPL', side: 'long', size: 1, entry: 10, maxSlippageBps: 50, walletId: 'wallet-1', pactId: 'pact-1', live: true,
  ...
  assert.match(validateToolArguments('paper_trade_open', {
    intentId: 'paper-intent-0001', symbol: 'AAPL', side: 'long', size: 1, entry: 10, maxSlippageBps: 50, walletId: 'wallet-1', pactId: 'pact-1',
